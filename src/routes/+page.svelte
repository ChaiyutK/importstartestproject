  ...
  <section class="present">
    ...
    <header class="viewport-header" in:fade={{ duration: 1000 }} out:fade>
      <div class="header-caption" in:fly={{ y: 200, duration: 3000 }} out:fly>
        ...
        <h1>Import Star</h1>
        <h2>
          High-quality web application that can support all of your needs.
        </h2>
        <h2>
          ให้บริการ Software Development ระดับมืออาชีพ พร้อมจะนำเสนอ Software
          ให้กับ ทุกไอเดียธุรกิจของคุณ ให้เกิดขึ้นจริง
        </h2>
      </div>
    </header>
  </section>
  ...
  {#if ready && y > 100}
    <div class="cardboard" in:fly={{ y: 200, duration: 3000 }} out:fly>
      ...
      <div class="card">
        ...
        <p>
          Messaging API
          ให้การสื่อสารระหว่างธุรกิจกับลูกค้าของคุณง่ายขึ้นเพื่อไม่ให้พลาดทุกข่าวสารโปรโมชั่นช่วยให้ธุรกิจและแบรนด์สร้าง
...
{#if ready && y > 400}
  <section class="webheadersection" in:fade={{ duration: 2000 }} out:fade>
    <div class="webheader">
      ...
      <h2>
        เราสามารถออกแบบให้ตรงตาม Requirements ที่เหมาะสมในแต่ละธุรกิจโดยเฉพาะ
      </h2>
    </div>
  </section>
{/if}
        ...
        <div class="slidecontent" in:fade={{ duration: 2000 }}>
          ...
          <div class="slidecontent-caption">
            ...
            <p>
              ...
              ด้วยระบบ Product management พร้อมเพิ่มความปลอดภัย Payment gateways
              and Securit ของเรา
            </p>
          </div>
        </div>
      ...
      {:else if pagenum == 3}
        <div class="slidecontent" in:fade={{ duration: 2000 }}>
          ...
          <div class="slidecontent-caption">
            ...
            <p>
              ระบบการจอง ไม่ว่าจะเป็น การจองโรงแรม ระบบจองโต๊ะร้านอาหาร หรือ
              แม้แต่จองคิวล้างรถ หากต้องการ Feature เหล่านี้ Import star
              สามารถออกแบบให้ตรงตามความต้องการได้
            </p>
          </div>
        </div>
      {:else if pagenum == 4}
  ...
  {#if ready && y > 1800}
    ...
    >
      <div class="contentimage-caption">
        <h2>UI/UX Design</h2>
        <p>
          ออกแบบและสร้างสรรค์เว็บไซต์ให้โดดเด่น มีประสิทธิภาพกว่าคู่แข่งของคุณ
...
{#if ready && y > 2600}
  <section class="webheadersection" in:fade={{ duration: 2000 }} out:fade>
    <div class="webheader">
      ...
      <h2>
        ส่งมอบ APPs เพิ่มความสะดวกสบายและช่องทางการเข้าถึงธุรกิจของคุณ
        ครบถ้วนทุกแพลตฟอร์ม
      </h2>
    </div>
  </section>
  ...
  {#if ready && y > 3000}
    ...
    >
      <div class="card longsize">
        ...
        <p>
          ครอบคุมทุกช่องทางจะเป็น iOS หรือ Android
      ...
      <div class="card longsize">
        ...
        <p>
          ตอบโจทย์ B2B และ B2C mobile solutions
          สำหรับภายในองค์กรหรือสำหรับลูกค้าขององค์กรเพื่อความปลอดภัยและประสบการณ์การใช้งานที่ดีที่สุด
        </p>
      </div>
    </div>
  {/if}
  ...
  {#if ready && y > 3900}
    ...
    >
      <div class="contentimage-caption">
        <h2>Line OA</h2>
        <p>
          ทางเราสามารถทำ Messaging API
          ทำให้การสื่อสารระหว่างธุรกิจกับลูกค้าของคุณง่ายขึ้น
          เพื่อไม่ให้พลาดทุกข่าวสารโปรโมชั่น ช่วยให้ธุรกิจและแบรนด์สร้าง
          Conversion ได้ดีขึ้น
        </p>
      </div>
      <div class="contentimage-image">
  ...
  {#if ready && y > 4500}
    <div class="techstack" in:fly={{ y: 200, duration: 2000 }} out:fade>
      ...
      <div class="techstack-image">
        {#if techstackpage == 1}
          <img
            src="/techstack/svelte-kit.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/strapi.jpg"
            alt=""
            srcset=""
        ...
        {#if techstackpage == 2}
          <img
            src="/techstack/svelte-logo.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/tailwind-css-logo-vector.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
          <img
            src="/techstack/alpine-js.jpg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1600 }}
          />
          <img
            src="/techstack/jinja.png"
            alt=""
            srcset=""
        ...
        {#if techstackpage == 3}
          <img
            src="/techstack/flask.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/fastapi.jpg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
        ...
        {#if techstackpage == 4}
          <img
            src="/techstack/PostgreSQL-Logo.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/Logo-redis.svg.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
          <img
            src="/techstack/MongoDB-Logo.jpg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1600 }}
          />
        ...
        {#if techstackpage == 5}
          <img
            src="/techstack/prettier.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/es.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
          <img
            src="/techstack/getpostman-ar21.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1600 }}
          />
        ...
        {#if techstackpage == 6}
          <img
            src="/techstack/Docker-Logo-2017-present.jpg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/NGINX-logo-rgb-large.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
          <img
            src="/techstack/gunicorn.jpeg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1600 }}
          />
          <img
            src="/techstack/uvicorn.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1900 }}
          />
          <img
            src="/techstack/uptime.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 2200 }}
          />
        {/if}
        {#if techstackpage == 7}
          <img
            src="/techstack/notion1411.jpg"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1000 }}
          />
          <img
            src="/techstack/Discord-logo.png"
            alt=""
            srcset=""
            in:fly={{ y: 200, duration: 1300 }}
          />
